...
export class AcousticMXBasic extends CutoutGenerator {
    ...
    generate(key, generatorOptions) {
        ...
        // Use switchHousingWidth from options, default to 1 if not present
        const width = generatorOptions.switchHousingWidth ? new Decimal(generatorOptions.switchHousingWidth) : new Decimal(1)
