...
export class StabilizerMXSpec extends CutoutGenerator {
    ...
    generate(key, generatorOptions) {
        ...
        const pointA = [new Decimal("-3.3274").toNumber(), new Decimal("5.6896").toNumber()]
        const pointB = [new Decimal("3.3274").toNumber(), new Decimal("5.6896").toNumber()]
        const pointC = [new Decimal("3.3274").toNumber(), new Decimal("-6.604").toNumber()]
        const pointD = [new Decimal("1.524").toNumber(), new Decimal("-6.604").toNumber()]
        const pointE = [new Decimal("1.524").toNumber(), new Decimal("-7.7724").toNumber()]
        const pointF = [new Decimal("-1.524").toNumber(), new Decimal("-7.7724").toNumber()]
        const pointG = [new Decimal("-1.524").toNumber(), new Decimal("-6.604").toNumber()]
        const pointH = [new Decimal("-3.3274").toNumber(), new Decimal("-6.604").toNumber()]
        const pointI = [new Decimal("-3.3274").toNumber(), new Decimal("-0.508").toNumber()]
        const pointJ = [new Decimal("-4.191").toNumber(), new Decimal("-0.508").toNumber()]
        const pointK = [new Decimal("-4.191").toNumber(), new Decimal("2.286").toNumber()]
        const pointL = [new Decimal("-3.3274").toNumber(), new Decimal("2.286").toNumber()]
        ...
        if (keySize.gte(3)) {
            pointW = [new Decimal("3.3274").toNumber(), new Decimal("2.3").toNumber()]
            pointZ = [new Decimal("3.3274").toNumber(), new Decimal("-2.3").toNumber()]

            pointXL = [new Decimal(stab_spacing_left).toNumber(), new Decimal("2.3").toNumber()]
            pointXR = [new Decimal(stab_spacing_right).toNumber(), new Decimal("2.3").toNumber()]
            pointYL = [new Decimal(stab_spacing_left).toNumber(), new Decimal("-2.3").toNumber()]
            pointYR = [new Decimal(stab_spacing_right).toNumber(), new Decimal("-2.3").toNumber()]
        } else {
            pointW = [new Decimal("3.3274").toNumber(), new Decimal("4.8768").toNumber()]
            pointZ = [new Decimal("3.3274").toNumber(), new Decimal("-5.8166").toNumber()]

            pointXL = [new Decimal(stab_spacing_left).toNumber(), new Decimal("4.8768").toNumber()]
            pointXR = [new Decimal(stab_spacing_right).toNumber(), new Decimal("4.8768").toNumber()]
            pointYL = [new Decimal(stab_spacing_left).toNumber(), new Decimal("-5.8166").toNumber()]
            pointYR = [new Decimal(stab_spacing_right).toNumber(), new Decimal("-5.8166").toNumber()]
        }
